...
console.log(e431.find(ephem.bodies.MARS, ephem.bodies.PLUTO, time));
console.log(e202.find(ephem.bodies.MARS, ephem.bodies.PLUTO, time));

position = ephem.radec(e431, ephem.bodies.MERCURY, time)
...
position = ephem.radec(e431, ephem.bodies.VENUS, time);
console.log(position);
...
position = ephem.radec(e431, ephem.bodies.MARS, time);
console.log(position);
...
position = ephem.radec(e431, ephem.bodies.JUPITER, time);
console.log(position);
...
position = ephem.radec(e431, ephem.bodies.SATURN, time);
console.log(position);
...
position = ephem.radec(e431, ephem.bodies.URANUS, time);
console.log(position);
...
position = ephem.radec(e431, ephem.bodies.NEPTUNE, time);
console.log(position);
